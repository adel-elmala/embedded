...
#define TICK_TIME_0_PRESCALE (1.0 / (F_CPU))
#define TICK_TIME_8_PRESCALE (8.0 / (F_CPU))
#define TICK_TIME_64_PRESCALE (64.0 / (F_CPU))
#define TICK_TIME_256_PRESCALE (256.0 / (F_CPU))
#define TICK_TIME_1024_PRESCALE (1024.0 / (F_CPU))
